...
export default function CityScreen() {
      ...
      <View style={styles.bannerContainer}>
        ...
        <View style={styles.textOverlay}>
             <Text style={styles.logo}>
                      VISIT<Text style={styles.highlight}>MY</Text>FAV
                    </Text>
        </View>
      </View>
      <Text style={styles.titrepage}>Favoris</Text>
 
      
      {batiments.filter(batiment => batiment.valide == 1).length > 0 ? (
  <FlatList
  ...
  <Text style={styles.noFavorisText}>Vous n'avez pas encore de bâtiments en favoris.</Text>
)}
